    ...
    await _apiRepository.getRegCourse().then((allRegCourse) {
      allRegCourse.forEach((element) {
        var cour = RegCourse(
            ...
            courseImage: element.unit.toString(),
            courseDescrip: element.status,
      ...
      _apiRepository.getChapter().then((allchapter) {
        allchapter.forEach((element) {
          var chapt = Chapter(
              ...
              progress: element.progress == null ? 0 : element.progress);
          chapter.add(chapt);
        });
      ...
      _apiRepository.getQuestions().then((allquestion) {
        ...
        allquestion.forEach((element) {
          var quest = Question(
            ...
            correctAnswer: element.option1.toString(),
        ...
        print("$question upolad");
        if (question.isNotEmpty) {
          ObjectBox.saveQuestion(question).then((value) {
            print(value);
          });
        }
      });
