...
class _OfflineDownloadsState extends State<OfflineDownloads> {
  ...
  Future task() async {
    ...
    for (var _task in getTasks!) {
      ...
      // print(downloadsListMaps);

      // var data = BetterPlayerDataSource(BetterPlayerDataSourceType.file, "",
      //     notificationConfiguration: BetterPlayerNotificationConfiguration(
      //       showNotification: true,
      //       imageUrl: _task.filename,
      //       title: _task.filename,
      //       author: _task.filename,
      //     ));

    }
    setState(() {
      // dataSource.length = downloadsListMaps.length;
    });
  }
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int i) {
                  ...
                  var data = BetterPlayerDataSource(
                      BetterPlayerDataSourceType.file, _file!.path,
                  ...
                  if (_status == DownloadTaskStatus.complete) {
                    dataSource.addIf(i == dataSource.length, data);
                  }
